...
tmp = ['A','B','C','D','E']
#dis_dir = 'F:/项目/花城音乐项目/参考代码/tensorflow_models_nets-master/raw_data/onsets/test/'
dis_dir = 'F:/项目/花城音乐项目/参考代码/tensorflow_models_nets-master/raw_data/onsets/'
...
for i in range(1,2):
    COOKED_DIR = 'F:/项目/花城音乐项目/样式数据/ALL/节奏/'
    #COOKED_DIR = 'F:/项目/花城音乐项目/样式数据/2.27MP3/节奏/'
