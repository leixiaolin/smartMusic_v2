...
if __name__ == "__main__":
    ...
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节4录音3(95).wav'
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节6谭（98）.wav'
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节4欧(95).wav'
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节4录音2(95).wav'
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节5录音2(88).wav'
    ...
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节1.4(50).wav'
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节10.1(97).wav'
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节5录音4(15).wav'
    filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/节奏/节奏七（1）（30）.wav'

    # filename = 'F:/项目/花城音乐项目/样式数据/1-2/节奏/节奏题二.9（100）.wav'
    # # filename = 'F:/项目/花城音乐项目/样式数据/1-2/节奏/节奏题九.2（100）.wav'
    # # filename = 'F:/项目/花城音乐项目/样式数据/1-2/节奏/节奏题十.3（100）.wav'
    # # filename = 'F:/项目/花城音乐项目/样式数据/1-2/节奏/'
    # filename = 'F:/项目/花城音乐项目/样式数据/1-2/节奏/节奏题一.2（100）.wav'
    # # filename = 'F:/项目/花城音乐项目/样式数据/1-2/节奏/节奏题一.6（100）.wav'
    # filename = 'F:/项目/花城音乐项目/样式数据/1-2/节奏/节奏一（3）（65）.wav'
