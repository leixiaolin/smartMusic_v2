...
mp3_path = "F:/项目/花城音乐项目/样式数据/3.19MP3/3.19节奏/"
wav_path = "F:/项目/花城音乐项目/样式数据/3.19MP3/节奏/"
...
for mp3 in mp3_file:
    if mp3.find("mp3") >= 0:
        ...
        str = "F:/ffmpeg/bin/ffmpeg -i "+ mp3_path + mp3 + " " + wav_path + mp3.split('mp3')[0].replace("第",'') + "wav"
        print(str)
