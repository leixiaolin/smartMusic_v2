...
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10熙(98).wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10文(97).wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10王（80）.wav'  # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10谭（98）.wav'  # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10欧(10).wav'      # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10罗（92）.wav'  # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10卉(90).wav'      # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10.4(60).wav'     # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10.3(92).wav'     # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10.2(96).wav'     # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋10.1(72).wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9熙(90).wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9文(80).wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9王（70）.wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9谭（95）.wav'   # 训练样本 ========================
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9欧(45).wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9罗（80）.wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9卉(80).wav'   # 训练样本
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9.2((85).wav'   # 训练样本 =========================
# filename = 'F:/项目/花城音乐项目/样式数据/3.06MP3/旋律/旋9.3(40).wav'   # 训练样本
# type_index = get_onsets_index_by_filename_rhythm(filename)
# rhythm_code = get_code(type_index, 2)
# pitch_code = get_code(type_index, 3)

# filename = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/五年级1，98.wav' # 训练样本
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/五年级2，96.wav'  # 训练样本
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/五年级3，78.wav'  # 训练样本
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/五年级4，85.wav'  # 训练样本
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/五年级5，56.wav'  # 训练样本
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/五年级6，25.wav'  # 训练样本
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律1，90.wav'  # 训练样本
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律3，55.wav'  # 训练样本
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律1，30.wav'
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律1，60.wav'
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律2，5.wav'
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律2，25.wav'
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律3，30.wav'
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律4，60.wav'
filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律4，95.wav'
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律5，30.wav'
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律6，55.wav'
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律7，95.wav'
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律8，98.wav'
# filename  = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律9，76.wav'
# filename   = 'F:/项目/花城音乐项目/样式数据/6.18MP3/旋律/旋律10，96.wav'
...
filename, rhythm_code, pitch_code = 'F:/项目/花城音乐项目/样式数据/8.28MP3/旋律/10.wav', '[2000;250,250,250,250,1000;2000;500,500,1000]', '[6,5,6,3,5,6,3,2,1,6-]'  # adfadfasdfadfasdfadfasdfadsfadfadf
filename, rhythm_code, pitch_code = 'F:/项目/花城音乐项目/样式数据/9.05MP3/旋律/x3.wav', '[2000;250,250,250,250,1000;2000;500,500,1000]', '[6,5,6,3,5,6,3,2,1,6-]'
filename, rhythm_code, pitch_code = 'F:/项目/花城音乐项目/样式数据/9.05MP3/旋律/z1.wav', '[500,250,250,500,500;1500,500;1000,1000;2000]', '[3,3,1,3,4,5,5,6,7,1+]'
filename, rhythm_code, pitch_code = 'F:/项目/花城音乐项目/样式数据/9.05MP3/旋律/z3.wav', '[500,1000,500;2000;500,250,250,500,500;2000]', '[1,3,4,5,6,6,1+,7,6,1+]'
filename, rhythm_code, pitch_code = 'F:/项目/花城音乐项目/样式数据/9.05MP3/旋律/z4.wav', '[500,1000,500;2000;500,500,500,250,250;2000]', '[1+,7,6,5,6,5,4,3,2,1]'

filename, rhythm_code, pitch_code = 'F:/项目/花城音乐项目/样式数据/9.08MP3/旋律/xx1.wav', '[1000,1000;500,250,250,1000;1000,500,500;2000]', '[3,1,5,5,6,5,1+,6,3,5]'
...
filename, rhythm_code, pitch_code = 'F:/项目/花城音乐项目/样式数据/9.08MP3/旋律/xx4.wav', '[1000,250,250,250,250;2000;1000,500,500;2000]', '[1,3,5,1+,6,5,1,3,2,1]'
