...
def train(train_record_file,
    ...
    with slim.arg_scope(resnet.resnet_arg_scope()):
        out, end_points = resnet.resnet_v2_50(inputs=input_images, num_classes=labels_nums,  is_training=is_training)
...
if __name__ == '__main__':
    ...
    train_record_file = './data/record/train.tfrecords'
    val_record_file = './data/record/val.tfrecords'
    ...
    snapshot_prefix='./models/resnet/model.ckpt'
