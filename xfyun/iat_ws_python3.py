...
def get_iat_result(filename):
    ...
    # print(ws.all_message)
    # print(ws.all_detail)
    return ws.all_message,ws.all_detail

if __name__ == "__main__":
    # 测试时候在此处正确填写相关信息即可运行
    filename = 'F:/项目/花城音乐项目/样式数据/20.04.01MP3/iat_pcm_16k.pcm'
    filename = 'F:/项目/花城音乐项目/样式数据/20.04.01MP3/人声打分_a.wav'
    filename = 'F:/项目/花城音乐项目/样式数据/20.04.01MP3/人声打分_a.pcm'
